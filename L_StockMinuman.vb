...
Public Class L_StockMinuman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Tugas_Aplikasi.L_StockMinuman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedL_StockMinuman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As L_StockMinuman = New L_StockMinuman()
        rpt.Site = Me.Site
        Return rpt
    End Function
